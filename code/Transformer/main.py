...
parser.add_argument('--project_name', type=str, default='transformer_CSI_mae',help='name of the experiment')
...
parser.add_argument('--exp_type', type=str, default='mae', help='[mae|pred]')
...
parser.add_argument('--adjust_interval', type=int, default=10, help='lr adjust interval')
